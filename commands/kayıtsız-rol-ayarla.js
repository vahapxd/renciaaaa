...
.setColor("#5555dd")
.setFooter("Adelicia 💚 Rencia")
.setDescription(":x: Yanlış Kullanım.. \n :star: Doğru Kullanım: .kayıtsız-rol-ayarla rol @role :( ")  
...
if(args[0] == "rol") {
    if (!rol) return message.channel.send("**:x: Lütfen bir Rol etiketleyip tekrar deneyin.**")
     db.set(`kaytsz_${message.guild.id}`, rol.id)
  var basarılı = new MessageEmbed()
  .setColor("#5555dd")
.setFooter("Adelicia 💚 Rencia")
.setDescription(":white_check_mark: Kayıtsız Rol Başarıyla Ayarlandı.")  
